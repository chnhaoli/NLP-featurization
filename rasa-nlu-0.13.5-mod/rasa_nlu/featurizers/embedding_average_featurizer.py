...
class EmbeddingAverageFeaturizer(Featurizer):
    ...
    def __init__(self, component_config=None):
        ...
        super(EmbeddingAverageFeaturizer, self).__init__(component_config)
    ...
    def persist(self, model_dir):
        ...
        return {"average_sentence_embedding_file": self.name + ".pkl"}
    ...
    def load(cls,
        ...
        if model_dir and meta.get("average_sentence_embedding_file"):
            file_name = meta.get("average_sentence_embedding_file")
            ...
            return EmbeddingAverageFeaturizer(meta)
