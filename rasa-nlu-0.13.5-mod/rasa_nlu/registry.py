...
# Custome components
from rasa_nlu.utils.arbitary_restart import ArbitaryRestart
from rasa_nlu.utils.arbitary_confidence_retriever import ArbitaryConfidenceRetriever
from rasa_nlu.utils.arbitary_confidence_setter import ArbitaryConfidenceSetter
from rasa_nlu.utils.tfidf_calculator import TfidfCalculator
from rasa_nlu.utils.word_vecor_model import WordVectorModel
from rasa_nlu.tokenizers.whitespace_tokenizer_lower import WhitespaceTokenizerLower

from rasa_nlu.tokenizers.gensim_tokenizer import GensimTokenizer

from rasa_nlu.sentanalyzers.textblob_sentiment_classifier import TextblobSentimentClassifier

from rasa_nlu.featurizers.embedding_tfidf_featurizer import EmbeddingTfidfFeaturizer
from rasa_nlu.featurizers.embedding_minmax_featurizer import EmbeddingMinMaxFeaturizer
from rasa_nlu.featurizers.embedding_average_featurizer import EmbeddingAverageFeaturizer
from rasa_nlu.classifiers.fasttext_classifier import FasttextIntentClassifier
...
component_classes = [
    ...
    EmbeddingIntentClassifier,
    # Custome components
    TextblobSentimentClassifier, 
    EmbeddingTfidfFeaturizer, EmbeddingMinMaxFeaturizer, EmbeddingAverageFeaturizer,
    ArbitaryConfidenceRetriever, ArbitaryConfidenceSetter, ArbitaryRestart,
    GensimTokenizer, WhitespaceTokenizerLower,
    TfidfCalculator, WordVectorModel,
