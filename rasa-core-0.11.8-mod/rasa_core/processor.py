...
class MessageProcessor(object):
    ...
    def handle_message(self, message):
        ...
        # Print the output for testing purpose
        # print('\nSlots:')
        # pp.pprint(tracker.current_state()['slots'])
        # print('Intent:')
        # pp.pprint(tracker.current_state()['latest_message']['intent'])
        # print('Entities:') 
        # pp.pprint(tracker.current_state()['latest_message']['entities'])
        # print('') 
